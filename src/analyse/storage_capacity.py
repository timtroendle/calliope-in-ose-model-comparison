...
def excavate_installed_storage_capacities(path_to_results, path_to_capacities_raw, path_to_capacities_publish):
    """Excavate installed storage capacities from the model results."""
    ...
    capacities = capacities.pivot(index="locs", columns="techs", values="storage_cap") / 1e3 # from MWh to GWh
